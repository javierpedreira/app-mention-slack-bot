# A Slack bot example that answers App mentions

This is a basic bot example that answers when a user mentions the app. Please check the [Slack documentation](https://api.slack.com/start/overview) and [examples](https://github.com/slack-samples) to check for inspiration.

![](example.png)

**Guide Outline**:

- [A Slack bot example that answers App mentions](#a-slack-bot-example-that-answers-app-mentions)
  - [Setup](#setup)
